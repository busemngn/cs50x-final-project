...
const getUserInputs = () => {
    ...
    // certifications
    let certDescriptionElem = document.querySelectorAll('.cert_description'),
    certDateElem = document.querySelectorAll('.cert_date');
    ...
    languageLevelElem = document.querySelectorAll('.language_level');
    ...
    certDescriptionElem.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'Description')));
    certDateElem.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'End Date')));
    ...
    languageLevelElem.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'Language level')));
    ...
    return {
        ...
        certifications: fetchValues(['cert_description', 'cert_date'], certDescriptionElem, certDateElem),
        experiences: fetchValues(['exp_title', 'exp_organization', 'exp_location', 'exp_start_date', 'exp_end_date', 'exp_description'], expTitleElem, expOrganizationElem, expLocationElem, expStartDateElem, expEndDateElem, expDescriptionElem),
        educations: fetchValues(['edu_school', 'edu_degree', 'edu_city', 'edu_start_date', 'edu_graduation_date', 'edu_description'], eduSchoolElem, eduDegreeElem, eduCityElem, eduStartDateElem, eduGraduationDateElem, eduDescriptionElem),
        projects: fetchValues(['proj_title', 'proj_link', 'proj_description'], projTitleElem, projLinkElem, projDescriptionElem),
        skills: fetchValues(['skill'], skillElem),
        languages: fetchValues(['language', 'language_level'], languageElem, languageLevelElem)
    }
};
